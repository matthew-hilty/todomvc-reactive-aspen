var cacheAppData, changeModeTo, compose, composing, connect, editAppState, editMode, endEditing, extractNewTodo, filteringEnter, filteringEscape, mapping, nodes, onValue, penultimateNodes, penultimateTransforms, plugIntoTerminus, removeCompletedTodos, removeTodo, restoreOrigTitle, saveCurrentTitle, storeCookie, storeTitle, toggleAllTodos, toggleTodo, transforms, _ref, _ref1, _ref2;
...
_ref2 = require('./transforms'), cacheAppData = _ref2.cacheAppData, changeModeTo = _ref2.changeModeTo, editAppState = _ref2.editAppState, editMode = _ref2.editMode, endEditing = _ref2.endEditing, extractNewTodo = _ref2.extractNewTodo, filteringEnter = _ref2.filteringEnter, filteringEscape = _ref2.filteringEscape, removeCompletedTodos = _ref2.removeCompletedTodos, removeTodo = _ref2.removeTodo, toggleAllTodos = _ref2.toggleAllTodos, toggleTodo = _ref2.toggleTodo, restoreOrigTitle = _ref2.restoreOrigTitle, saveCurrentTitle = _ref2.saveCurrentTitle, storeCookie = _ref2.storeCookie, storeTitle = _ref2.storeTitle;
...
penultimateNodes = ['$todo-label-doubleclicks', '$hash-events', 'cookieManager', '$active-todos', '$all-todos', '$completed-todos'];

penultimateTransforms = [mapping(editAppState), mapping(editMode), composing(storeCookie), mapping(changeModeTo('active')), mapping(changeModeTo('all')), mapping(changeModeTo('completed'))];
